/**
 * Modified from https://github.com/ScratchAddons/ScratchAddons/blob/master/addons/debugger/module.js
 * Criginal (c) ScratchAddons contributors
...
export const setup = (virtualMachine) => {
  if (vm) {
    return;
  }
